...
__global__ void multTiled(int *A, int *B, int *C,int rA,int cA,int rB,int cB){
...
__global__ void matrixMulKernel(int *d_A, int *d_B, int *d_C,int rA,int cA,int rB,int cB){
